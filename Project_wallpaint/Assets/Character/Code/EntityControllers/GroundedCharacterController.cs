...
public class GroundedCharacterController : CharacterControllerBase {
    [SerializeField] float m_WalkForce;
    [SerializeField] float m_WalkForceApplyLimit;
    [SerializeField] float m_StoppingForce;
    [SerializeField] bool m_ApplyStoppingForceWhenActivelyBraking;
    [SerializeField] float m_AirControl;
    [SerializeField] float m_AirForceApplyLimit;
    [SerializeField] float m_DragConstant;
    [SerializeField] float m_Gravity;
    [SerializeField] bool m_ApplyGravityOnGround;
    [SerializeField] bool m_ApplyGravityIntoGroundNormal;
    [SerializeField] float m_FrictionConstant;
    [SerializeField] bool m_AlignRotationToGroundedNormal;
    //Jumping values
    [SerializeField] float m_JumpVelocity;
    [SerializeField] float m_JumpCutVelocity;
    [SerializeField] float m_MinAllowedJumpCutVelocity;
    [SerializeField] float m_GroundedToleranceTime;
    [SerializeField] float m_JumpCacheTime;
    [SerializeField] float m_JumpAlignedToGroundFactor;
    [SerializeField] float m_HorizontalJumpBoostFactor;
    [SerializeField] bool m_ResetVerticalSpeedOnJumpIfMovingDown;
