...
public class CrouchingModule : GroundedControllerAbilityModule {
    [SerializeField] float m_CrouchHeight;
    [SerializeField] float m_CrouchAcceleration;
    [SerializeField] float m_MaxCrouchSpeed;
    [SerializeField] float m_CrouchBrakeDeceleration;
    [SerializeField] float m_CrouchFriction;
