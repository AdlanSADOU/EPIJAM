...
public class WallSlidingModule : GroundedControllerAbilityModule {
    ...
    [SerializeField] bool m_ApplyFrictionIfGoingUpwards;
    [SerializeField] float m_EscapeCornerRaycastDistance;
    [SerializeField] float m_EscapeVelocity;
    [SerializeField] bool m_HonorJumpCut;
    [SerializeField] bool m_UseSameGravityForAllSlopes;
