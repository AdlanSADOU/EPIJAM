...
public class WallJumpModule : GroundedControllerAbilityModule {
    ...
    [SerializeField] float m_JumpAlignedToWallFactor;
    [SerializeField] bool m_UseWallUpDirection;
    [SerializeField] bool m_ResetVerticalSpeedIfFalling;
    [SerializeField] float m_VerticalVelocityInheritanceFactor;
    [SerializeField] float m_HorizontalVelocityInheritanceFactor;
