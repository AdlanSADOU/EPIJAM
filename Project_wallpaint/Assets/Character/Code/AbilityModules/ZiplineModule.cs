...
public class ZiplineModule : GroundedControllerAbilityModule {
    [SerializeField] float m_ZiplineReachRadius;
    [SerializeField] float m_MaxSpeed;
    [SerializeField] float m_DownhillAcceleration;
    [SerializeField] float m_UphillAcceleration;
    [SerializeField] float m_Deceleration;
    [SerializeField] LayerMask m_ZiplineMask;
    [SerializeField] float m_ZiplineClimbCoolDown;
    [SerializeField] bool m_CanReleaseZiplineWithInput;
    [SerializeField] bool m_CanJumpFromZipline;
