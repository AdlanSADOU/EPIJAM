...
public class NetClimbModule : GroundedControllerAbilityModule {
    [SerializeField] float m_NetReachRadius;
    [SerializeField] float m_Speed;
    [SerializeField] LayerMask m_NetMask;
    [SerializeField] float m_NetClimbCoolDown;
    [SerializeField] bool m_CanPassThroughOneWayPlatforms;
    [SerializeField] bool m_CanExitTopOfNet;
    [SerializeField] bool m_CanExitSidesOfNet;
    [SerializeField] bool m_CanExitBottomOfNet;
    [SerializeField] bool m_CanReleaseNetWithButton;
    [SerializeField] bool m_CanJumpFromNet;
