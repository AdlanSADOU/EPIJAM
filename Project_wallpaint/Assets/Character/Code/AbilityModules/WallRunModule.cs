...
public class WallRunModule : GroundedControllerAbilityModule {
    ...
    [SerializeField] bool m_DisableWhenBelowVelocity;
    [SerializeField] float m_MinimumUpVelocityOnStart;
    [SerializeField] bool m_AllowOnlyWhenJustTouchingWall;
    [SerializeField] bool m_ResetVelocityOnStart;
    [SerializeField] bool m_ApplyDrag;
