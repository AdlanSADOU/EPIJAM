...
public class JetpackModule : GroundedControllerAbilityModule {
    [SerializeField] float m_JetpackForce;
    [SerializeField] float m_MaxUpwardsVelocity;
    [SerializeField] float m_MinUpwardsVelocity;
    [SerializeField] bool m_UnlimitedFuel;
    [SerializeField] float m_MaxFuel;
    [SerializeField] float m_FuelConsumptionRate;
    [SerializeField] float m_FuelRegenerationRate;
    [SerializeField] bool m_AlwaysRefuel;
    [SerializeField] bool m_RefuelWhileTouchingGround;
    [SerializeField] bool m_RefuelWhileTouchingWall;
    [SerializeField] bool m_RefuelWhileTouchingEdge;
    [SerializeField] bool m_AllowStartWhileMovingUpwards;
