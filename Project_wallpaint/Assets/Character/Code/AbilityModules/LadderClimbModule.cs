...
public class LadderClimbModule : GroundedControllerAbilityModule {
    [SerializeField] float m_LadderReachRadius;
    [SerializeField] float m_Speed;
    [SerializeField] LayerMask m_LadderMask;
    [SerializeField] float m_LadderClimbCoolDown;
    [SerializeField] bool m_CanPassThroughOneWayPlatforms;
    [SerializeField] bool m_CanExitTopOfLadder;
    [SerializeField] bool m_CanExitSidesOfLadder;
    [SerializeField] bool m_CanExitBottomOfLadder;
    [SerializeField] bool m_CanReleaseLadderWithButton;
    [SerializeField] bool m_CanJumpFromLadder;
    [SerializeField] float m_VerticalJumpVelocity;
    [SerializeField] float m_HorizontalJumpVelocity;
    [SerializeField] bool m_UseNormalVerticalJumpVelocity;
